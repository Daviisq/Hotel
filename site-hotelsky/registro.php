...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: url('Components/homeee.png') no-repeat center center fixed;
...
<body>
    <div class="container">
        <div class="intro">
            <img src="image.png" alt="Ilustração">
            <p>
        ...
        <div class="login">
            ...
            <a href="Components/cadastro.php">Já tem uma conta? Faça login</a>
        </div>
    </div>
</body>
</html>
